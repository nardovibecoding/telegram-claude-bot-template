...
class TestWritePromptVersion(unittest.TestCase):
    def setUp(self):
        ...
        self.current_path = os.path.join(self.tmpdir, "assistant_current.md")
        ...
        self._current_path = os.path.join(self._mock_prompts, "assistant_current.md")
    ...
    def test_snapshots_current_prompt(self):
        ...
        versioned = os.path.join(self._mock_prompts, "assistant_v001.md")
        self.assertTrue(os.path.exists(versioned))
        with open(versioned) as f:
            self.assertEqual(f.read(), "You are an assistant.")
...
class TestRollbackPrompt(unittest.TestCase):
    def setUp(self):
        ...
        # Create v001
        self._v001 = os.path.join(self._mock_prompts, "assistant_v001.md")
        with open(self._v001, "w") as f:
            f.write("original prompt")
        self._current = os.path.join(self._mock_prompts, "assistant_current.md")
