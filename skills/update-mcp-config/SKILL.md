...
# VPS
ssh <user>@<vps-ip> "cat ~/.claude/settings.json | python3 -c \"import sys,json; print(json.dumps(json.load(sys.stdin)['mcpServers'], indent=2))\""
```
...
# VPS
ssh <user>@<vps-ip> "cat ~/.claude/settings.json | python3 -c \"import sys,json; d=json.load(sys.stdin); print(json.dumps(d['mcpServers'], indent=2))\""
```
