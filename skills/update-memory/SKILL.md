...
## Memory locations
- **Mac**: `~/.claude/projects/[project-dir]/memory/`
- **VPS**: `~/.claude/projects/[project-dir]/memory/`
...
### 2. Write memory file
Create or update `~/.claude/projects/[project-dir]/memory/<name>.md`:
...
- Owner's preferences and feedback
...
- Project dir name is derived from the working directory path (run `ls ~/.claude/projects/` to find it)
